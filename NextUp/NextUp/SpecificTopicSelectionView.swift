...
struct SpecificTopicSelectionView: View {
    ...
    var topics = [
        "Programming": ["Web Development", "Game Development", "Mobile Development", "Machine Learning"],
        "Art": ["Drawing", "Painting", "Photography", "Graphic Design"],
        "Languages": ["Spanish", "French", "Chinese", "Amharic"],
        "Cooking": []
    ]
...
#Preview {
    SpecificTopicSelectionView(selectedCategory: "Art")
}
